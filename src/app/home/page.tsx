  ...
  return (
    <div className="min-h-screen bg-background text-on-background overflow-x-hidden selection:bg-primary-container selection:text-on-primary-container">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 pt-4">
        <div className="w-full max-w-6xl glass rounded-2xl border border-outline-variant/40 shadow-lg px-5 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-outline-variant/60 bg-surface-container text-on-surface-variant hover:text-on-surface hover:bg-surface-container-high hover:border-primary/30 transition-all duration-200 text-sm font-medium"
            >
              {theme === 'dark' ? (
                <>
                  {/* sun icon */}
      ...
      <section className="relative z-10 min-h-screen flex items-center pt-28 pb-20 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto w-full grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          ...
          {/* ── left: copy ── */}
          <div>
            <div className="hero-badge inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-primary-container/70 border border-primary/20 text-on-primary-container text-[11px] font-bold uppercase tracking-widest mb-7">
            ...
            <div className="hero-cta flex flex-wrap gap-3 mb-9">
              ...
              <Link href="/auth/login"
                className="px-7 py-3.5 rounded-xl border-2 border-outline-variant text-on-surface font-bold text-sm hover:border-primary hover:text-primary hover:bg-primary-container/20 transition-all duration-300">
                Sign In →
              </Link>
            </div>
          ...
          <div className="relative hidden lg:flex items-center justify-center py-10">
            <div className="relative w-full max-w-[360px] mx-auto">
              ...
              <div className="card p-6 relative z-10">
                ...
                <div className="flex items-center justify-between text-xs pt-3 border-t border-outline-variant/40">
              ...
              {/* streak badge */}
              <div className="float-card absolute -top-6 -right-8 z-20 card px-4 py-3 flex items-center gap-2.5 shadow-xl border border-outline-variant/40">
              ...
              {/* xp badge */}
              <div className="float-card-delayed absolute -bottom-6 -left-8 z-20 card px-4 py-3 flex items-center gap-2.5 shadow-xl border border-outline-variant/40">
                <span className="text-2xl">⚡</span>
                <div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={label} className="card px-6 py-8 text-center border border-outline-variant/30 hover:border-primary/30 transition-all duration-300">
          ...
          <div className="grid sm:grid-cols-3 gap-5" data-reveal>
            {[
              ...
              >
                ...
                {i < 2 && (
                  <div className="hidden sm:flex absolute -right-2.5 top-1/2 -translate-y-1/2 z-10 w-5 h-5 rounded-full bg-surface-container-high border border-outline-variant items-center justify-center">
        ...
        <div className="max-w-4xl mx-auto" data-reveal>
          <div className="relative overflow-hidden rounded-3xl">
            ...
            <div className="relative z-10 px-8 sm:px-16 py-16 sm:py-20 text-center">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/15 text-white/80 text-xs font-bold uppercase tracking-widest mb-7">
                🎓 Free Forever
              </div>
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <Link href="/auth/login"
                  className="px-8 py-4 rounded-xl border-2 border-white/25 text-white font-bold text-sm hover:bg-white/10 hover:border-white/50 transition-all duration-300">
      ...
      <footer className="relative z-10 px-4 sm:px-6 pb-10">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t border-outline-variant/40">
