  ...
  return (
    <div className="min-h-screen bg-background text-on-background overflow-hidden selection:bg-primary-container selection:text-on-primary-container">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50">
        <div className="mx-4 mt-4 max-w-7xl xl:mx-auto rounded-2xl bg-surface/80 backdrop-blur-xl border border-outline-variant/60 shadow-ambient">
          <div className="flex items-center justify-between px-6 py-3">
            ...
            <div className="flex items-center gap-3 shrink-0">
              <Link
                href="/auth/login"
                className="hidden sm:inline-flex px-5 py-2 rounded-lg text-sm font-semibold text-on-surface-variant border border-outline-variant hover:bg-surface-container-high hover:text-on-surface transition-all"
              >
                Sign In
              </Link>
              <Link
