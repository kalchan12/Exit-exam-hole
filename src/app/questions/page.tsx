    ...
    return (
      <div className="animate-pulse space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {[1,2,3,4,5,6].map(i => <div key={i} className="h-36 bg-gray-200 dark:bg-dark-700 rounded-2xl" />)}
        </div>
      </div>
    );
  }
  ...
  if (!selectedCategory) {
    return (
      <div className="space-y-12 animate-in py-4">
        ...
        <Link 
          href="/dashboard" 
          className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors flex items-center gap-2"
        >
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <div className="flex items-center gap-2 bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-full px-4 py-2 backdrop-blur-md">
              ...
              <span className="text-gray-900 dark:text-white font-black text-xs italic">{questions.length} Total Qs</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <button
            ...
            className="group relative flex flex-col items-start rounded-3xl bg-white dark:bg-[#11152a]/50 border border-gray-200 dark:border-white/5 p-8 text-left transition-all duration-500 hover:bg-gray-50 dark:hover:bg-[#11152a] hover:border-accent-purple/30 hover:-translate-y-1 hover:shadow-2xl hover:shadow-accent-purple/10"
          >
            ...
            <h3 className="text-xl font-black text-gray-900 dark:text-white italic uppercase tracking-tighter mb-2 group-hover:text-accent-purple-light transition-colors">
              All <br /> Questions
            </h3>
          ...
          {topics.map((topic) => {
            ...
            return (
              <button
                ...
                className="group relative flex flex-col items-start rounded-3xl bg-white dark:bg-[#11152a]/50 border border-gray-200 dark:border-white/5 p-5 sm:p-8 text-left transition-all duration-500 hover:bg-gray-50 dark:hover:bg-[#11152a] hover:border-accent-purple/30 hover:-translate-y-1 hover:shadow-2xl hover:shadow-accent-purple/10"
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-gray-100 dark:bg-white/5 flex items-center justify-center text-xl sm:text-2xl mb-4 sm:mb-8 group-hover:bg-accent-purple/10 group-hover:scale-110 transition-all duration-500">
                  {meta.icon}
                </div>
                <h3 className="text-lg sm:text-xl font-black text-gray-900 dark:text-white italic uppercase tracking-tighter mb-1 sm:mb-2 group-hover:text-gray-900/90 dark:group-hover:text-white/90 transition-colors h-12 flex items-center">
                ...
                <div className="w-full mt-auto">
                  ...
                  <div className="w-full h-1 sm:h-1.5 bg-gray-100 dark:bg-white/5 rounded-full overflow-hidden">
                    <div 
                      className="h-full bg-accent-purple rounded-full transition-all duration-1000 ease-out shadow-[0_0_10px_rgba(124,58,237,0.5)]"
                      style={{ width: `${percent}%` }}
                    />
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <button
            ...
            className="inline-flex items-center gap-1.5 text-xs text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors bg-gray-100 dark:bg-dark-800 border border-gray-200 dark:border-dark-400/20 rounded-lg px-3 py-2"
          >
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5 bg-gray-100 dark:bg-dark-800 border border-gray-200 dark:border-dark-400/20 rounded-lg px-3 py-1.5">
            <span className="text-accent-purple-light font-bold text-sm">{progress.xp}</span>
            <span className="text-[10px] text-gray-500 dark:text-gray-400">XP</span>
          </div>
          <div className="flex items-center gap-1.5 bg-gray-100 dark:bg-dark-800 border border-gray-200 dark:border-dark-400/20 rounded-lg px-3 py-1.5">
      ...
      <div className="card p-3">
        <div className="flex flex-wrap gap-2">
          ...
          <select
            ...
            className="bg-gray-100 dark:bg-dark-600 border border-gray-200 dark:border-dark-400/50 rounded-lg px-3 py-1.5 text-xs text-gray-900 dark:text-white focus:border-accent-purple focus:outline-none"
          >
          ...
          <button
            ...
            className={`text-xs flex items-center gap-1.5 px-3 py-1.5 rounded-lg border transition-all ${
              isRandomMode
                ...
                : 'border-gray-200 dark:border-dark-400/50 bg-gray-100 dark:bg-dark-600 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white'
            }`}
          >
            <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      {isFinished ? (
        <div className="card p-12 text-center space-y-8 animate-in zoom-in-95">
          ...
          <div className="grid grid-cols-2 gap-4 max-w-sm mx-auto">
            <div className="p-6 rounded-2xl bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10">
              ...
              <div className="text-[10px] text-gray-500 dark:text-gray-400 font-black uppercase tracking-widest mt-1">Score</div>
            </div>
            <div className="p-6 rounded-2xl bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10">
              <div className="text-3xl font-black text-accent-purple italic">{quizScore.correct}/{quizScore.total}</div>
              <div className="text-[10px] text-gray-500 dark:text-gray-400 font-black uppercase tracking-widest mt-1">Problems</div>
            </div>
          </div>
          ...
          <div className="max-w-xl mx-auto text-left space-y-6">
            <h3 className="text-sm font-black text-gray-500 dark:text-gray-400 uppercase tracking-[0.2em] flex items-center gap-2">
            ...
            <div className="space-y-4">
              {Array.from(new Set(filteredQuestions.filter(q => sessionAnswers[q.id]).map(q => q.topic))).map(topic => {
                ...
                return (
                  <div key={topic} className="p-4 rounded-2xl bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 group hover:border-accent-purple/30 transition-all">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button 
              onClick={() => setSelectedCategory(null)}
              className="px-10 py-3 rounded-xl border border-gray-200 dark:border-white/10 bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 text-gray-500 dark:text-gray-400 font-black uppercase italic tracking-widest text-sm transition-all shadow-lg hover:shadow-gray-200/50 dark:hover:shadow-white/5"
            >
              Exit Practice
            </button>
          </div>
        ...
        <div className="card p-4 sm:p-8 animate-in slide-in-from-bottom-5 duration-500">
          <div className="flex flex-wrap items-center gap-1 sm:gap-2 mb-3 sm:mb-6">
            ...
            <span className="badge bg-gray-100 dark:bg-dark-500 text-gray-500 dark:text-gray-400 text-[10px] sm:text-xs truncate max-w-[100px] sm:max-w-none">
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-2 py-1 rounded-md text-[10px] sm:text-xs font-medium transition-colors ${
                    deleteConfirm === currentQuestion.id 
                      ...
                      : 'bg-gray-100 dark:bg-dark-600 text-gray-500 dark:text-gray-400 hover:text-red-400 hover:bg-red-500/10 border border-gray-200 dark:border-dark-400/50 hover:border-red-500/30'
                  }`}
                >
          ...
          <div>
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2 sm:gap-4 mb-3 sm:mb-4">
              <h2 className="text-sm sm:text-xl font-semibold text-gray-900 dark:text-white leading-snug sm:leading-relaxed flex-1">
          ...
          <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
            {currentQuestion.options.map((option, idx) => {
              ...
              if (!isAnswered) {
                optionClass += 'border-transparent hover:border-accent-purple/40 hover:bg-gray-100 dark:hover:bg-dark-600/60';
              } else if (isCorrect) {
                ...
                >
                  <span className={`w-6 h-6 sm:w-8 sm:h-8 rounded-md sm:rounded-lg flex items-center justify-center text-[10px] sm:text-sm font-semibold flex-shrink-0 mt-0.5 sm:mt-0 ${
                    isAnswered && isCorrect
                      ...
                      : 'bg-gray-100 dark:bg-dark-500 text-gray-500 dark:text-gray-400'
                  }`}>
                    {String.fromCharCode(65 + idx)}
                  </span>
                  <span className={`text-xs sm:text-base font-medium leading-snug sm:leading-relaxed ${isAnswered && isCorrect ? 'text-green-400' : isAnswered && isSelected ? 'text-red-400' : 'text-gray-700 dark:text-gray-200'}`}>
                    {option}
                  </span>
                  {isAnswered && isCorrect && (
          ...
          {/* Explanation */}
          {showExplanation && (
            <div className="animate-slide-up rounded-xl p-5 bg-gray-100 dark:bg-dark-600/60 border border-gray-200 dark:border-dark-400/30 mb-6">
              <div className="flex items-center gap-2 mb-2">
          ...
          {/* Navigation */}
          <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-dark-400/20">
            <button
        ...
        <div className="card p-20 text-center">
          <p className="text-gray-500 dark:text-gray-400 mb-4">No questions found for this topic.</p>
