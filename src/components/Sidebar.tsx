  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
      <div className={`relative ${isCollapsed ? 'py-6' : 'px-6 py-5'}`}>
        ...
        <div className={`flex items-center gap-3 relative ${isCollapsed ? 'justify-center' : ''}`}>
          ...
          <button
            ...
            className="hidden lg:flex text-on-surface-variant hover:text-on-surface transition-colors p-2 rounded-lg hover:bg-surface-container-high"
            aria-label={isCollapsed ? 'Expand sidebar' : 'Collapse sidebar'}
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} strokeLinecap="square">
